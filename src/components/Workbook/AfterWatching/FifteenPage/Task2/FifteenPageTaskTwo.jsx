    ...
    <>
      ...
      <div className="fifteen__first--column">
        <div className="block__fifteen--page">
          <img alt="img" src={inputValues[0].img}></img>
        ...
        <div className="block__fifteen--page">
          <img alt="img" src={inputValues[1].img}></img>
          <div className="input__block--fifteen">
            <input
              type="text"
      ...
      <div className="fifteen__second--column">
        <div className="block__fifteen--page">
          <img alt="img" src={inputValues[2].img}></img>
          <div className="input__block--fifteen">
            <input
              type="text"
        ...
        <div className="block__fifteen--page">
          <img alt="img" src={inputValues[3].img}></img>
          <div className="input__block--fifteen">
            <input
              type="text"
        ...
        <div className="block__fifteen--page">
          <img alt="img" src={inputValues[4].img}></img>
          <div className="input__block--fifteen">
            <input
              type="text"
